"""
Django settings for mitchs_site project.
...
WSGI_APPLICATION = 'mitchs_site.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://postgres:postgres@127.0.0.1:5432/mitchs_site'
    )
}
